...
development contract for humans and coding agents working on `@sqhh99/dsh-tui`.
...
contract for humans and coding agents working on `@sqhh99/dsh-tui`.

`@sqhh99/dsh-tui` is a single-package, ESM-only TypeScript project. It provides a
