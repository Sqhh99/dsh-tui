...
try {
  ...
  writeFileSync(join(sourceRoot, 'package.json'), JSON.stringify({ name: '@sqhh99/dsh-tui', version: '1.2.3', type: 'module' }))
  ...
  writeFileSync(join(pkgRoot, 'package.json'), JSON.stringify({ name: '@sqhh99/dsh-tui', version: '0.9.9', type: 'module' }))
...
check(
  ...
  compiledSource.includes('@sqhh99/dsh-tui'),
)
