 ...
 * `@sqhh99/dsh-tui/working-activity` instead of the bare package name.
 *
 ...
 * `dsh-working-activity` name (a transitive dependency of @sqhh99/dsh-tui) fails
 ...
 * subpath keeps resolution anchored at @sqhh99/dsh-tui itself — always a direct
 * profile dependency — and from its real location `dsh-working-activity`
 * resolves under every package-manager layout.
 * @module @sqhh99/dsh-tui/working-activity
 */
