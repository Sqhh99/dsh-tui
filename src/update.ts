...
const PACKAGE_NAME = '@sqhh99/dsh-tui'
 ...
 */
export const LAUNCHER_ENV = 'DSH_TUI_LAUNCHER'
 ...
 */
export function hasRelaunchingLauncher(env: NodeJS.ProcessEnv = process.env): boolean {
  return env[LAUNCHER_ENV] === '1'
}
 ...
 */
export async function restartTui(
  sessionId: string,
