...
import { LEGACY_PREFS_DIR, PREFS_DIR } from './paths.js'

const HISTORY_DIR = PREFS_DIR
const HISTORY_FILE = join(HISTORY_DIR, 'history.jsonl')
const LEGACY_HISTORY_FILE = join(LEGACY_PREFS_DIR, 'history.jsonl')
...
function loadRaw(): HistoryEntry[] {
  const file = existsSync(HISTORY_FILE)
    ? HISTORY_FILE
    : existsSync(LEGACY_HISTORY_FILE)
      ? LEGACY_HISTORY_FILE
      : undefined
