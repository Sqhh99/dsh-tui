 ...
 * tools). Toggle with Ctrl+T (see HelpMenu); the panel renders only while
 * the transcript is still empty — the first message's rows take over.
 * Renders nothing for an empty snapshot.
