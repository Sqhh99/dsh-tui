 ...
 */
export function wordmarkColumns(text, tracking = TRACKING) {
    let width = 0;
 ...
 */
export function trackingToFit(text, columns) {
 ...
 */
export function renderBigText(text, stops, tracking = TRACKING) {
 ...
 */
export function renderBigTextSolid(text, color, tracking = TRACKING) {
